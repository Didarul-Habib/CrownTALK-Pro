      ...
      <AnimatePresence>
        {open ? (
          ...
          >
            ...
            >
              {/* Halo ring (edge-only) */}
              <div className="relative rounded-[calc(var(--ct-radius)+18px)] p-[3px] shadow-2xl">
                <div className="pointer-events-none absolute inset-0 rounded-[calc(var(--ct-radius)+18px)]">
                  <div className="ct-border-spin h-full w-full rounded-[calc(var(--ct-radius)+18px)] bg-[conic-gradient(from_140deg_at_50%_50%,rgba(34,211,238,0.8),rgba(129,140,248,0.95),rgba(236,72,153,0.95),rgba(34,211,238,0.8))] opacity-90 blur-[1px]" />
                </div>
              ...
              <div className="relative overflow-hidden rounded-[calc(var(--ct-radius)+10px)] border border-white/10 bg-[color:var(--ct-panel)]/85 backdrop-blur-2xl">
                ...
                <div className="pointer-events-none absolute inset-0">
                  <div className="absolute inset-0 bg-[url('/galaxy.jpg')] bg-cover bg-center opacity-25" />
                ...
                <div className="relative p-5 sm:p-6">
                  <button
                    type="button"
                    aria-label="Close"
                    className="absolute right-3 top-3 rounded-full border border-white/10 bg-black/30 p-2 text-white/80 hover:text-white hover:bg-black/40"
                    onClick={() => setOpen(false)}
                  >
                    <X className="h-4 w-4" />
                  </button>
